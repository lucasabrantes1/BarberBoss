using BarberBoss.Application.UseCases.Invoicing.Reports.Colors;
...
public class GenerateInvoicingReportPdfUseCase : IGenerateInvoicingReportPdfUseCase
{
    ...
    public GenerateInvoicingReportPdfUseCase(IInvoicingReadOnlyRepository repository)
    {
        _repository = repository;

        GlobalFontSettings.FontResolver = new InvoicingReportFontsResolve();
    }
